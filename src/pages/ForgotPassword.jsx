      ...
      <div className='flex justify-center items-center py-6 px-12 max-w-6xl mx-auto flex-wrap'>
        ...
        <div className='w-full lg:w-[40%] md:w-[67%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            ...
            <button type="submit" className='uppercase w-full bg-blue-600 py-2 px-7 text-sm text-white font-medium rounded shadow-md hover:bg-blue-700 transition duration-200 ease-in-out active:bg-blue-800 '>Send Forgot Password</button>
